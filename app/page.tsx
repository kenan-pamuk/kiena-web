...
const organizationJsonLd = {
  ...
  logo: {
    "@type": "ImageObject",
    url: "https://www.kiena.com.tr/assets/kiena_logo_glowyn.png",
  },
  description:
    "Kiena, yapay zekâ ve veri teknolojileriyle insan odaklı dijital ürünler geliştiren teknoloji şirketidir.",
  sameAs: [
    "https://www.instagram.com/heyglowyn",
    "https://www.facebook.com/p/Glowyn-AI-61591561779098/",
  ],
};
            ...
            <section className="hero glowyn-hero">
              <div className="hero-copy glowyn-hero-copy">
                ...
                <div className="hero-actions">
                  <Link
                    href="/hakkimizda"
                    className="primary glowyn-primary"
                  >
                  ...
                  >
                    Glowyn&apos;i İnceleyin
                    <span
                      className="glowyn-discover-icon"
                      aria-hidden="true"
                    >
                      ✨
                    </span>
              ...
              <div
                className="hero-visual glowyn-hero-visual"
                aria-hidden="true"
              >
